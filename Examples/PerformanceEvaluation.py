...
import sys
sys.path.append('/Users/sotakao/Documents/GitHub/pyStateEstimator')
...
max_iter = 50
num_seeds = 15
RMSE_db = np.zeros((num_seeds, max_iter))
NLL_db = np.zeros((num_seeds, max_iter))
...
# # %%
# iterations = np.arange(0, max_iter)

# RMSE_anomalies_removed = remove_anomalies(RMSE_db, 10, tolerance=0.8)
# RMSE_mean = RMSE_anomalies_removed.mean(axis=0)
# RMSE_anomaly = RMSE_anomalies_removed - RMSE_mean[None]
# RMSE_variance = (RMSE_anomaly**2).mean(axis=0)
# RMSE_std = np.sqrt(RMSE_variance)

# plt.plot(iterations, RMSE_mean)
# plt.fill_between(iterations, RMSE_mean-RMSE_std, RMSE_mean+RMSE_std, alpha=0.2)

# # %%
# NLL_anomalies_removed = remove_anomalies(NLL_db, 10, tolerance=20000)
# #NLL_anomalies_removed = NLL_db[:10]
# NLL_mean = NLL_anomalies_removed.mean(axis=0)
# NLL_anomaly = NLL_anomalies_removed - NLL_mean[None]
# NLL_variance = (NLL_anomaly**2).mean(axis=0)
# NLL_std = np.sqrt(NLL_variance)

# plt.plot(iterations, NLL_mean)
# plt.fill_between(iterations, NLL_mean-NLL_std, NLL_mean+NLL_std, alpha=0.2)
# # %%
